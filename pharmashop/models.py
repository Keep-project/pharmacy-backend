...
class Medicament(models.Model):
    ...
    prix = models.PositiveBigIntegerField(null=False, blank=False, default=1)
    ...
    stockAlert = models.PositiveBigIntegerField(null=False, blank=False, default=1)
    stockOptimal = models.PositiveBigIntegerField(null=False, blank=False, default=1)
